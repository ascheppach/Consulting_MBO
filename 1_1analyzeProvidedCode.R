...
#### Exercice 1.1: Analyze the optimization runs of the provided code — how much does the optimization improve over the initial data, how much improvement is achieved in each step, where does the BO explore and where does it exploit
...
save(Lars_Code, file = "Lars.Rdata")
